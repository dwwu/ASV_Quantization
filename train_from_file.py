...
parser.add_argument("-model_size", type=str, choices=['S', 'M', 'L'],
...
train_ds = generate_voxc1_ds("/tmp/sv_set/voxc1/fbank64/dev/train/",
        frame_range=frame_range, is_train=True)
train_ds = train_ds.padded_batch(batch_size,
        padded_shapes=([None, 1, 65], []),
        drop_remainder=False)
val_ds = generate_voxc1_ds("/tmp/sv_set/voxc1/fbank64/dev/val/",
        frame_range=frame_range, is_train=False)
